...
### This code is based on Mattia Chiesa1, Giada Maioli2, and Luca Piacentini1
### This version includes some modifications for parallel computing and allowing the user to use his own cost function.
